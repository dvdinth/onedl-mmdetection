...
atss = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/atss/atss_r50_fpn_1x_coco/atss_r50_fpn_1x_coco_20200209-985f7bd0.pth', # noqa
    eval='bbox',
...
autoassign = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/autoassign/auto_assign_r50_fpn_1x_coco/auto_assign_r50_fpn_1x_coco_20210413_115540-5e17991f.pth', # noqa
    eval='bbox',
...
carafe = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/carafe/faster_rcnn_r50_fpn_carafe_1x_coco/faster_rcnn_r50_fpn_carafe_1x_coco_bbox_mAP-0.386_20200504_175733-385a75b7.pth', # noqa
    eval='bbox',
...
cascade_rcnn = [
    dict(
        ...
        eval='bbox',
        url='https://mmassets.onedl.ai/mmdetection/v2.0/cascade_rcnn/cascade_rcnn_r50_fpn_1x_coco/cascade_rcnn_r50_fpn_1x_coco_20200316-3dc56deb.pth', # noqa
    ...
    dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/cascade_rcnn/cascade_mask_rcnn_r50_fpn_1x_coco/cascade_mask_rcnn_r50_fpn_1x_coco_20200203-9d4dcb24.pth', # noqa
        eval=['bbox', 'segm'],
...
cascade_rpn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/cascade_rpn/crpn_faster_rcnn_r50_caffe_fpn_1x_coco/crpn_faster_rcnn_r50_caffe_fpn_1x_coco-c8283cca.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.4),
)
centernet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/centernet/centernet_resnet18_dcnv2_140e_coco/centernet_resnet18_dcnv2_140e_coco_20210702_155131-c8cd631f.pth', # noqa
    eval='bbox',
...
centripetalnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/centripetalnet/centripetalnet_hourglass104_mstest_16x6_210e_coco/centripetalnet_hourglass104_mstest_16x6_210e_coco_20200915_204804-3ccc61e5.pth', # noqa
    eval='bbox',
...
convnext = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/convnext/cascade_mask_rcnn_convnext-s_p4_w7_fpn_giou_4conv1f_fp16_ms-crop_3x_coco/cascade_mask_rcnn_convnext-s_p4_w7_fpn_giou_4conv1f_fp16_ms-crop_3x_coco_20220510_201004-3d24f5a4.pth', # noqa
    eval=['bbox', 'segm'],
...
cornernet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/cornernet/cornernet_hourglass104_mstest_8x6_210e_coco/cornernet_hourglass104_mstest_8x6_210e_coco_20200825_150618-79b44c30.pth', # noqa
    eval='bbox',
...
dcn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/dcn/faster_rcnn_r50_fpn_dconv_c3-c5_1x_coco/faster_rcnn_r50_fpn_dconv_c3-c5_1x_coco_20200130-d68aed1e.pth', # noqa
    eval='bbox',
...
dcnv2 = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/dcn/faster_rcnn_r50_fpn_mdpool_1x_coco/faster_rcnn_r50_fpn_mdpool_1x_coco_20200307-c0df27ff.pth', # noqa
    eval='bbox',
...
ddod = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/ddod/ddod_r50_fpn_1x_coco/ddod_r50_fpn_1x_coco_20220523_223737-29b2fc67.pth', # noqa
    eval='bbox',
...
deformable_detr = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/deformable_detr/deformable_detr_r50_16x2_50e_coco/deformable_detr_r50_16x2_50e_coco_20210419_220030-a12b9512.pth', # noqa
    eval='bbox',
...
detectors = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/detectors/detectors_htc_r50_1x_coco/detectors_htc_r50_1x_coco-329b1453.pth', # noqa
    eval=['bbox', 'segm'],
...
detr = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/detr/detr_r50_8x2_150e_coco/detr_r50_8x2_150e_coco_20201130_194835-2c4b8974.pth', # noqa
    eval='bbox',
...
double_heads = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/double_heads/dh_faster_rcnn_r50_fpn_1x_coco/dh_faster_rcnn_r50_fpn_1x_coco_20200130-586b67df.pth', # noqa
    eval='bbox',
...
dyhead = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/dyhead/atss_r50_fpn_dyhead_4x4_1x_coco/atss_r50_fpn_dyhead_4x4_1x_coco_20211219_023314-eaa620c6.pth', # noqa
    eval='bbox',
...
dynamic_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/dynamic_rcnn/dynamic_rcnn_r50_fpn_1x/dynamic_rcnn_r50_fpn_1x-62a3f276.pth', # noqa
    eval='bbox',
...
efficientnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/efficientnet/retinanet_effb3_fpn_crop896_8x4_1x_coco/retinanet_effb3_fpn_crop896_8x4_1x_coco_20220322_234806-615a0dda.pth', # noqa
    eval='bbox',
...
empirical_attention = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/empirical_attention/faster_rcnn_r50_fpn_attention_1111_1x_coco/faster_rcnn_r50_fpn_attention_1111_1x_coco_20200130-403cccba.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.0),
)
faster_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth', # noqa
    eval='bbox',
...
fcos = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/fcos/fcos_center-normbbox-centeronreg-giou_r50_caffe_fpn_gn-head_1x_coco/fcos_center-normbbox-centeronreg-giou_r50_caffe_fpn_gn-head_1x_coco-0a0d75a8.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=38.7),
)
foveabox = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/foveabox/fovea_align_r50_fpn_gn-head_4x4_2x_coco/fovea_align_r50_fpn_gn-head_4x4_2x_coco_20200203-8987880d.pth', # noqa
    eval='bbox',
...
fpg = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/fpg/mask_rcnn_r50_fpg_crop640_50e_coco/mask_rcnn_r50_fpg_crop640_50e_coco_20220311_011857-233b8334.pth', # noqa
    eval=['bbox', 'segm'],
...
free_anchor = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/free_anchor/retinanet_free_anchor_r50_fpn_1x_coco/retinanet_free_anchor_r50_fpn_1x_coco_20200130-0f67375f.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=38.7),
)
fsaf = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/fsaf/fsaf_r50_fpn_1x_coco/fsaf_r50_fpn_1x_coco-94ccc51f.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=37.4),
)
gcnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/gcnet/mask_rcnn_r50_fpn_syncbn-backbone_r16_gcb_c3-c5_1x_coco/mask_rcnn_r50_fpn_syncbn-backbone_r16_gcb_c3-c5_1x_coco_20200202-587b99aa.pth', # noqa
    eval=['bbox', 'segm'],
...
gfl = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/gfl/gfl_r50_fpn_1x_coco/gfl_r50_fpn_1x_coco_20200629_121244-25944287.pth', # noqa
    eval='bbox',
...
ghm = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/ghm/retinanet_ghm_r50_fpn_1x_coco/retinanet_ghm_r50_fpn_1x_coco_20200130-a437fda3.pth', # noqa
    eval='bbox',
...
gn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/gn/mask_rcnn_r50_fpn_gn-all_2x_coco/mask_rcnn_r50_fpn_gn-all_2x_coco_20200206-8eee02a6.pth', # noqa
    eval=['bbox', 'segm'],
...
gn_ws = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/gn%2Bws/faster_rcnn_r50_fpn_gn_ws-all_1x_coco/faster_rcnn_r50_fpn_gn_ws-all_1x_coco_20200130-613d9fe2.pth', # noqa
    eval='bbox',
...
grid_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/grid_rcnn/grid_rcnn_r50_fpn_gn-head_2x_coco/grid_rcnn_r50_fpn_gn-head_2x_coco_20200130-6cca8223.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.4),
)
groie = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/groie/faster_rcnn_r50_fpn_groie_1x_coco/faster_rcnn_r50_fpn_groie_1x_coco_20200604_211715-66ee9516.pth', # noqa
    eval='bbox',
...
guided_anchoring = dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/guided_anchoring/ga_retinanet_r50_caffe_fpn_1x_coco/ga_retinanet_r50_caffe_fpn_1x_coco_20201020-39581c6f.pth', # noqa
        eval='bbox',
...
hrnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/hrnet/faster_rcnn_hrnetv2p_w18_1x_coco/faster_rcnn_hrnetv2p_w18_1x_coco_20200130-56651a6d.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=36.9),
)
htc = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/htc/htc_r50_fpn_1x_coco/htc_r50_fpn_1x_coco_20200317-7332cf16.pth', # noqa
    eval=['bbox', 'segm'],
...
instaboost = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/instaboost/mask_rcnn_r50_fpn_instaboost_4x_coco/mask_rcnn_r50_fpn_instaboost_4x_coco_20200307-d025f83a.pth', # noqa
    eval=['bbox', 'segm'],
...
libra_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/libra_rcnn/libra_faster_rcnn_r50_fpn_1x_coco/libra_faster_rcnn_r50_fpn_1x_coco_20200130-3afee3a9.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=38.3),
)
mask2former = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/mask2former/mask2former_r50_lsj_8x2_50e_coco-panoptic/mask2former_r50_lsj_8x2_50e_coco-panoptic_20220326_224516-11a44721.pth', # noqa
    eval=['bbox', 'segm', 'PQ'],
...
mask_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/mask_rcnn/mask_rcnn_r50_fpn_1x_coco/mask_rcnn_r50_fpn_1x_coco_20200205-d4b0c5d6.pth', # noqa
    eval=['bbox', 'segm'],
...
maskformer = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/maskformer/maskformer_r50_mstrain_16x1_75e_coco/maskformer_r50_mstrain_16x1_75e_coco_20220221_141956-bc2699cb.pth', # noqa
    eval='PQ',
    metric=dict(PQ=46.9),
)
ms_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/ms_rcnn/ms_rcnn_r50_caffe_fpn_1x_coco/ms_rcnn_r50_caffe_fpn_1x_coco_20200702_180848-61c9355e.pth', # noqa
    eval=['bbox', 'segm'],
...
nas_fcos = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/nas_fcos/nas_fcos_nashead_r50_caffe_fpn_gn-head_4x4_1x_coco/nas_fcos_nashead_r50_caffe_fpn_gn-head_4x4_1x_coco_20200520-1bdba3ce.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=39.4),
)
nas_fpn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/nas_fpn/retinanet_r50_nasfpn_crop640_50e_coco/retinanet_r50_nasfpn_crop640_50e_coco-0ad1f644.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.5),
)
paa = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/paa/paa_r50_fpn_1x_coco/paa_r50_fpn_1x_coco_20200821-936edec3.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.4),
)
pafpn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/pafpn/faster_rcnn_r50_pafpn_1x_coco/faster_rcnn_r50_pafpn_1x_coco_bbox_mAP-0.375_20200503_105836-b7b4b9bd.pth', # noqa
    eval='bbox',
...
panoptic_fpn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/panoptic_fpn/panoptic_fpn_r50_fpn_1x_coco/panoptic_fpn_r50_fpn_1x_coco_20210821_101153-9668fd13.pth', # noqa
    eval='PQ',
    metric=dict(PQ=40.2),
)
pisa = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/pisa/pisa_faster_rcnn_r50_fpn_1x_coco/pisa_faster_rcnn_r50_fpn_1x_coco-dea93523.pth', # noqa
    eval='bbox',
...
point_rend = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/point_rend/point_rend_r50_caffe_fpn_mstrain_1x_coco/point_rend_r50_caffe_fpn_mstrain_1x_coco-1bcb5fb4.pth', # noqa
    eval=['bbox', 'segm'],
...
pvt = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/pvt/retinanet_pvt-s_fpn_1x_coco/retinanet_pvt-s_fpn_1x_coco_20210906_142921-b6c94a5b.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=40.4),
)
queryinst = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/queryinst/queryinst_r50_fpn_1x_coco/queryinst_r50_fpn_1x_coco_20210907_084916-5a8f1998.pth', # noqa
    eval=['bbox', 'segm'],
...
regnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/regnet/mask_rcnn_regnetx-3.2GF_fpn_1x_coco/mask_rcnn_regnetx-3.2GF_fpn_1x_coco_20200520_163141-2a9d1814.pth', # noqa
    eval=['bbox', 'segm'],
...
reppoints = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/reppoints/reppoints_moment_r50_fpn_1x_coco/reppoints_moment_r50_fpn_1x_coco_20200330-b73db8d1.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=37.0),
)
res2net = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/res2net/faster_rcnn_r2_101_fpn_2x_coco/faster_rcnn_r2_101_fpn_2x_coco-175f1da6.pth', # noqa
    eval='bbox',
...
resnest = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/resnest/faster_rcnn_s50_fpn_syncbn-backbone%2Bhead_mstrain-range_1x_coco/faster_rcnn_s50_fpn_syncbn-backbone%2Bhead_mstrain-range_1x_coco_20200926_125502-20289c16.pth', # noqa
    eval='bbox',
...
resnet_strikes_back = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/resnet_strikes_back/mask_rcnn_r50_fpn_rsb-pretrain_1x_coco/mask_rcnn_r50_fpn_rsb-pretrain_1x_coco_20220113_174054-06ce8ba0.pth', # noqa
    eval=['bbox', 'segm'],
...
retinanet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/retinanet/retinanet_r50_fpn_1x_coco/retinanet_r50_fpn_1x_coco_20200130-c2398f9e.pth', # noqa
    eval='bbox',
...
rpn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/rpn/rpn_r50_fpn_1x_coco/rpn_r50_fpn_1x_coco_20200218-5525fa2e.pth', # noqa
    eval='proposal_fast',
...
sabl = [
    dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/sabl/sabl_retinanet_r50_fpn_1x_coco/sabl_retinanet_r50_fpn_1x_coco-6c54fd4f.pth', # noqa
        eval='bbox',
    ...
    dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/sabl/sabl_faster_rcnn_r50_fpn_1x_coco/sabl_faster_rcnn_r50_fpn_1x_coco-e867595b.pth', # noqa
        eval='bbox',
...
scnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/scnet/scnet_r50_fpn_1x_coco/scnet_r50_fpn_1x_coco-c3f09857.pth', # noqa
    eval='bbox',
...
scratch = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/scratch/mask_rcnn_r50_fpn_gn-all_scratch_6x_coco/scratch_mask_rcnn_r50_fpn_gn_6x_bbox_mAP-0.412__segm_mAP-0.374_20200201_193051-1e190a40.pth', # noqa
    eval=['bbox', 'segm'],
...
solo = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/solo/decoupled_solo_r50_fpn_1x_coco/decoupled_solo_r50_fpn_1x_coco_20210820_233348-6337c589.pth', # noqa
    eval='segm',
...
solov2 = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/solov2/solov2_r50_fpn_1x_coco/solov2_r50_fpn_1x_coco_20220512_125858-a357fa23.pth', # noqa
    eval='segm',
...
sparse_rcnn = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/sparse_rcnn/sparse_rcnn_r50_fpn_1x_coco/sparse_rcnn_r50_fpn_1x_coco_20201222_214453-dc79b137.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=37.9),
)
ssd = [
    dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/ssd/ssd300_coco/ssd300_coco_20210803_015428-d231a06e.pth', # noqa
        eval='bbox',
    ...
    dict(
        ...
        url='https://mmassets.onedl.ai/mmdetection/v2.0/ssd/ssdlite_mobilenetv2_scratch_600e_coco/ssdlite_mobilenetv2_scratch_600e_coco_20210629_110627-974d9307.pth', # noqa
        eval='bbox',
...
swin = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/swin/mask_rcnn_swin-t-p4-w7_fpn_1x_coco/mask_rcnn_swin-t-p4-w7_fpn_1x_coco_20210902_120937-9d6b7cfa.pth', # noqa
    eval=['bbox', 'segm'],
...
tood = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/tood/tood_r50_fpn_1x_coco/tood_r50_fpn_1x_coco_20211210_103425-20e20746.pth', # noqa
    eval='bbox',
...
tridentnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/tridentnet/tridentnet_r50_caffe_1x_coco/tridentnet_r50_caffe_1x_coco_20201230_141838-2ec0b530.pth', # noqa
    eval='bbox',
...
vfnet = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/vfnet/vfnet_r50_fpn_1x_coco/vfnet_r50_fpn_1x_coco_20201027-38db6f58.pth', # noqa
    eval='bbox',
...
yolact = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/yolact/yolact_r50_1x8_coco/yolact_r50_1x8_coco_20200908-f38d58df.pth', # noqa
    eval=['bbox', 'segm'],
...
yolo = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/yolo/yolov3_d53_320_273e_coco/yolov3_d53_320_273e_coco-421362b6.pth', # noqa
    eval='bbox',
...
yolof = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/yolof/yolof_r50_c5_8x8_1x_coco/yolof_r50_c5_8x8_1x_coco_20210425_024427-8e864411.pth', # noqa
    eval='bbox',
    metric=dict(bbox_mAP=37.5),
)
yolox = dict(
    ...
    url='https://mmassets.onedl.ai/mmdetection/v2.0/yolox/yolox_tiny_8x8_300e_coco/yolox_tiny_8x8_300e_coco_20211124_171234-b4047906.pth', # noqa
    eval='bbox',
